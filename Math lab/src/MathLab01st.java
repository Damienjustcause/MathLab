...
// Leave comments in place for any methods that you have not finished.
	...
	{	
		...
		System.out.println("Circle Perimeter (circumference): " + Geometry.Circumfrence(radius));
		System.out.println("\n");
	}
	...
	{	
		...
		System.out.println("Trapezoid Area:                   " + Geometry.Trapezoid(base1,base2,height));
...
return b * h/2; 		
	...
	public static double squarePrismVolume ( double side, double h)
	{
		return (side * side) * h;
	}
	...
	public static double cylinderVolume (double h, double radius)
	{
